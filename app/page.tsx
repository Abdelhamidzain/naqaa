      ...
      <section className="section-spacing">
        <div className="container-page max-w-3xl">
          ...
          <p className="text-base leading-loose mb-6" style={{ color: 'var(--muted)' }}>
            ...
            نحن الخيار الأمثل لتنظيف المنازل باحترافية — يبدأ فريقنا بتقييم ميداني يحدد طبيعة الأسطح والأقمشة ودرجة اتساخها، ثم يختار المعدات والمحاليل المثلى لكل حالة.
